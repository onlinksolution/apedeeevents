  ...
  return (
    <main className="overflow-x-hidden">
      <section>
        ...
        <img src="/hero.jpg" alt="hero-img" className="w-full h-screen object-cover object-center" />
      </section>
      ...
      <section id="welcome">
        <div>
          <div className="grid absolute z-30 justify-center items-center w-full h-full">
            <div className="">
              <div className="w-full grid justify-center" data-aos="zoom-in">
                <img src="./welcome-text.png" className="mdnav:w-80 max-w-lg" />
              </div>
          ...
          <div className="w-full h-full bg-black/50 absolute"></div>
          <img src="/welcome.jpg" className="w-full h-screen object-cover object-center" />
        </div>
      </section>
